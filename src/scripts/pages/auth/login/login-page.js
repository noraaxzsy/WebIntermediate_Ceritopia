    ...
    return `
      <section class="login-container">
        <article class="login-form-container">
          <h1 class="login__title">Selamat Datang di Ceritopia!</h1>
          ...
          <form id="login-form" class="login-form">
            ...
            <p class="login-form__do-not-have-account">Belum punya akun? <a href="#/register" class="link-redirect">Daftar</a></p>
          </form> 
