    ...
    return `
      <section class="register-container">
        <article class="register-form-container">
          <h1 class="register__title">Selamat Datang di Ceritopia!</h1>
          ...
          <form id="register-form" class="register-form">
            ...
            <div class="form-buttons register-form__form-buttons">
              ...
              <p class="register-form__already-have-account">Sudah punya akun? <a href="#/login" class="link-redirect">Masuk</a></p>
            </div>
          </form>
        </article>
        <aside class="aside-img-login-register">
        <img class="img-login-register" src="images/gambar-login-register.png" alt="gambar-login-register">
        </aside>
      </section>
    `;
  }
